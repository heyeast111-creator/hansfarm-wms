...
async function load() {
    try {
        ...
        document.getElementById('acc-period-start').value = `${yyyy}-${mm}-01`; 
        document.getElementById('acc-period-end').value = `${yyyy}-${mm}-${dd}`; 
        ...
        let viewProd = document.getElementById('view-products');
